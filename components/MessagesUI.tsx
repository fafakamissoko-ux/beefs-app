  ...
  return (
    <div className={`flex flex-1 overflow-hidden bg-transparent ${
      ...
      <ConfirmModal
        ...
        onConfirm={() => { setShowPurgeConfirm(false); void clearEntireConversation(); }}
        title="Vider la discussion"
        description="Es-tu sûr de vouloir supprimer tout l'historique ? Cette action est irréversible."

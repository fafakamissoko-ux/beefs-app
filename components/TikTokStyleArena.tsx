  ...
  return (
    <div className="relative flex h-full min-h-0 w-full flex-col overflow-hidden bg-black md:h-[calc(100dvh-3.5rem)] md:max-h-[calc(100dvh-3.5rem)] md:min-h-[calc(100vh-3.5rem)] lg:grid lg:grid-cols-[1fr_320px] xl:grid-cols-[1fr_384px] 2xl:grid-cols-[1fr_420px]">
      ...
      {/* TikTok Battle : calques stricts — vidéo (fond) + UI chat (md+ mobile overlay) ;
          Strapping #97 : sur ≥ lg, grille 2-colonnes [vidéo | sidebar]. Le TikTok Battle
          occupe la col 1 (1fr) garanti par le grid parent. `min-w-0` évite overflow. */}
      <div className="relative min-h-0 h-full flex-1 min-w-0 flex flex-col overflow-hidden bg-[#08080A] md:block md:min-h-0 lg:col-start-1 lg:row-start-1 lg:flex-none lg:h-full">

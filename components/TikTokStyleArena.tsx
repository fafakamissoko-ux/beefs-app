      ...
      <div className="relative flex min-h-0 w-full max-w-full flex-1 flex-col bg-[#08080A]">
        {dailyRoomUrl ? (
          ...
          >
            ...
            <div className={`pointer-events-none absolute inset-0 z-10 flex h-full min-h-0 flex-col items-stretch gap-0 px-1 landscape:flex-row lg:flex-row lg:gap-4 lg:pb-[90px] landscape:pb-[80px] transition-shadow duration-700 ${sponsorGlow}`}>
              {/* LEFT — Participant A */}
              <motion.div
                ...
                >
                  <div className="relative">
                    ...
                    <button
                      ...
                      className={`pointer-events-auto relative h-[min(170px,32dvh)] w-[min(170px,32dvh)] shrink-0 overflow-hidden rounded-full border-4 border-prestige-gold bg-prestige-gold shadow-glow ring-2 ring-prestige-gold/30 transition-transform active:scale-[0.98] touch-manipulation ${auraFeverMed ? 'saturate-150 brightness-110' : ''} ${mediatorMicEnabled ? 'animate-pulse shadow-[0_0_40px_rgba(251,191,36,0.6)]' : ''}`}
                    >
        ...
        <div className="relative z-[65] pointer-events-none min-h-0 w-full shrink-0 flex-[0_0_60%] landscape:flex-1 lg:flex-1 overflow-hidden">
          <div className="pointer-events-none absolute inset-0 z-10 flex h-full min-h-0 w-full flex-col items-stretch gap-0 landscape:flex-row lg:flex-row lg:gap-4 lg:pb-[90px] landscape:pb-[80px]">
          {debaters[0] ? (
          ...
          <div className="pointer-events-auto absolute left-1/2 top-1/2 z-50 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center gap-2">
            ...
            >
              <div
                className={`flex h-[min(170px,32dvh)] w-[min(170px,32dvh)] shrink-0 items-center justify-center rounded-full border-4 border-prestige-gold bg-prestige-gold text-4xl text-black shadow-glow ring-2 ring-prestige-gold/40${mediatorMicEnabled ? ' animate-pulse shadow-[0_0_40px_rgba(251,191,36,0.6)]' : ''}`}
              >
                👤
              </div>
              <button

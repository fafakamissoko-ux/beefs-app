# Rapport d'audit — Phase V.0 (404 cadeaux + Chat + Pointer-events)

**Date d'extraction :** 2026-07-16  
**Commit de référence :** `c9316af fix(arena): gift PNG path, mobile chat density, input focus ring (Phase U.1)`  
**Contrainte :** Zéro modification du code source.

---

## Synthèse diagnostic Phase V

| Zone | État actuel | Diagnostic |
|------|-------------|------------|
| Fichiers disque | `salt.png.png`, `wolf.png.png`, etc. | Extension réelle : **`.png.png`** |
| Code `imageSrc` | `/gifts/${giftTypeId}.png` | Requête HTTP vers **`.png`** → **404 garanti** |
| Chat mobile hauteur | `max-h-[25dvh]` | Phase U.1 appliquée |
| Input focus | `focus:ring-2 focus:ring-white/20` | Phase U.1 appliquée |
| Conteneur messages mobile | `pointer-events-none` | Phase U.1 appliquée |
| Bulles message mobile | `pointer-events-auto` | Interaction ciblée sur chaque message |

**Cause racine 404 :** décalage entre le chemin code (`.png`) et les fichiers physiques (`.png.png`). Correction V.1 = renommer les assets **ou** restaurer `.png.png` dans `imageSrc`.

---

## 1. Inventaire strict — `public/gifts/`

```text
Commande exécutée (Windows PowerShell) :
Get-ChildItem -Force public\gifts | Format-Table Mode, Length, Name -AutoSize

Sortie brute :

Mode     Length Name
----     ------ ----
-a----  4176231 banger.png.png
-a---- 14446138 big_brain.png.png
-a----  2474165 champion.png.png
-a----  6116097 goat.png.png
-a----   334519 ko.png.png
-a----  6584455 lightning.png.png
-a----  4790183 meteor.png.png
-a----   343087 mic_drop.png.png
-a----   992056 salt.png.png
-a----  4865556 spicy.png.png
-a----  9761669 volcano.png.png
-a---- 22306099 wolf.png.png

Total : 12 fichiers — tous en double extension `.png.png` (minuscules, snake_case).
Aucun fichier `{id}.png` simple présent sur disque.
```

---

## 2. Code source intégral — `components/TikTokStyleArena.tsx`
...
## 3. Code source intégral — `components/ArenaChatMessages.tsx`
